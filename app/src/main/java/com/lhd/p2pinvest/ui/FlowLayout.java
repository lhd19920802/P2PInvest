...
/**
 * Created by lihuaidong on 2017/8/15 15:12.
 * 微信：lhd520ssp
 * QQ:414320737
 * 作用：
 */
public class FlowLayout extends ViewGroup
{
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        ...
        Log.e("TAG", "allViews.size = " + allViews.size() + ",allHeights.size = " + allHeights
                .size());
